 ...
 * | category   | 0 \| 1 \| 2 \| 3 \| 4 | Which category to sort by (0 = trending, date ranked = 1,               | 
 * |            |                       | scores set = 2, star difficulty = 3, author = 4)                        |
 * | sort       | 0 \| 1                | The sorting order: 0 (Descending) or 1 (Ascending).                     |
 ...
 * @param {number} gameMode SoloStandard by default. Only supported mode by ScoreSaber
 * @returns {Promise} Information on queried leaderboard
 */
